...
This repository includes **a hands‑on lab**, that guides you through building a React Frontend that connects to an API server and performs full **CRUD** operations (Create, Read, Update, Delete).


### **What to Expect in Each Lab**

[Part 1: Iterations 0–5](./part1.md) — Build a full CRUD front-end:
